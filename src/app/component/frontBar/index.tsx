...
export default function FrontBar() {
  return (
    <div className="flex my-2 lg:my-2 md:my-2 sm:my-2 w-full  flex-col items-center justify-center p-16 lg:flex-col lg:items-center lg:justify-center lg:p-16 md:flex-col md:items-center md:justify-center md:p-16 sm:flex-col sm:items-center sm:justify-center sm:p-16 bg-aliceblue ">
